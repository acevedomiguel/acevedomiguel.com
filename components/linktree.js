...
export default function Index() {
    ...
    <>
        ...
        <div className="px-4 mx-auto mb-4 sm:max-w-xl">
            <div className="grid max-w-2xl sm:mx-auto">
                <a href="https://www.buymeacoffee.com/acevedomiguel" target="_blank" className="linktree-buymeacoffee overflow-hidden rounded-2xl shadow-sm">
        ...
        <div className="px-4 mx-auto mb-4 sm:max-w-xl">
            <div className="grid max-w-2xl sm:mx-auto">
                <a href="https://www.instagram.com/acevedomiguel/" target="_blank" className="linktree-instagram overflow-hidden rounded-2xl shadow-sm">
                    <div className="text-white flex items-center justify-between p-5 rounded-sm">
                        <div className="pr-4">
