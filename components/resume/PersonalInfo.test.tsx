...
describe('PersonalInfo Component', () => {
  ...
  it('handles missing profiles gracefully', () => {
    ...
    render(<PersonalInfo basics={testBasics as unknown as ResumeData['basics']} />);
    ...
    expect(screen.queryByText('linkedin.com/in/johndoe')).not.toBeInTheDocument();
  });
  ...
  it('applies homepage-consistent spacing patterns', () => {
    ...
    const summary = screen.getByText('Experienced software engineer with expertise in full-stack development.');
