    ...
    <div className='container pt-4'></div>
        <div className='rounded-lg overflow-hidden md:my-4 pb-4 my-0'>
          <div className='flex bg-slate-600 text-white font-light'>
            <img className="rounded-none w-48 h-auto hidden md:block" alt="profile picture" src={cv.basics.image} />
            <div className='p-8'>
              <h1 className="text-3xl lg:text-5xl antialiased font-medium">Acevedo Miguel</h1>
