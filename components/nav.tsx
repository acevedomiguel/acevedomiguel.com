		...
		<header className="text-gray-600 body-font">
            ...
            <picture>
              <img
                ...
                alt="signature logo acevedo miguel"
              ...
              />
				...
				<nav className="md:py-1 md:px-4 items-center text-base">
					<a href="/" className="mx-4 md:mx-8 hover:text-gray-700 text-sm">
						home
					</a>
					<a href="/resume" className="mx-4 md:mx-8 hover:text-black text-sm">
						resume
					</a>
