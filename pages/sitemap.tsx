  ...
  const sitePages = [
    {
      title: "Home",
      url: "/",
      description: "Learn about Acevedo Miguel, Senior DevOps & Backend Engineer with 20+ years experience"
    },
    {
      title: "Resume",
      url: "/resume",
      description: "Complete professional resume with work experience, skills, and achievements"
    },
    {
      title: "Contact",
      url: "/contact",
      description: "Get in touch for DevOps consulting, backend development, or IoT projects"
    }
  ];
      ...
      <Container>
        ...
        <main role="main" id="main-content">
          <article className="max-w-3xl mx-auto py-8">
            ...
            <section aria-labelledby="main-pages">
              ...
              <nav aria-label="Site map navigation">
                <ul className="space-y-6" role="list">
                  {sitePages.map((page) => (
                    <li key={page.url} className="border-l-4 border-sky-600 pl-4">
                      ...
                      <span className="text-xs text-gray-400 font-mono">
                        {page.url === '/' ? 'acevedomiguel.com' : `acevedomiguel.com${page.url}`}
                      </span>
                    </li>
                  ))}
                </ul>
            ...
            <section className="mt-12 pt-8 border-t border-gray-200" aria-labelledby="technical-info">
              ...
              <div className="grid md:grid-cols-2 gap-6 text-sm">
                <div>
                  <h3 className="font-medium text-gray-900 mb-2">SEO Resources</h3>
